...
<Gallery
  srcArray={[
    { url: '/media/blog/Nodemcu/board.JPG', alt: 'board', className: '' },
    { url: '/media/blog/Nodemcu/cables.JPG', alt: 'cables', className: '' },
    { url: '/media/blog/Nodemcu/display.JPG', alt: 'display', className: '' },
    {
