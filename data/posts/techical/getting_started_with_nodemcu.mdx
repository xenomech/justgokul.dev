...
<Gallery
  srcArray={[
    {
      url: 'https://static.justgokul.dev/media/blog/Nodemcu/board.JPG',
      alt: 'board',
      className: '',
    },
    {
      url: 'https://static.justgokul.dev/media/blog/Nodemcu/cables.JPG',
      alt: 'cables',
      className: '',
    },
    {
      url: 'https://static.justgokul.dev/media/blog/Nodemcu/display.JPG',
      alt: 'display',
      className: '',
    },
    {
      url: 'https://static.justgokul.dev/media/blog/Nodemcu/breadBoard.JPG',
      alt: 'bread board',
      className: '',
    },
  ]}
...
<Flex>
  ...
  <Image
    alt={'data'}
    src={`https://static.justgokul.dev/media/blog/Nodemcu/Schematic_ESP8266.png`}
  ...
  <Image
    alt={'data'}
    src={`https://static.justgokul.dev/media/blog/Nodemcu/oie_JvW4GPLKJNQY.jpg`}
    tails={'p-2 flex justify-start'}
    width={400}
    height={400}
    priority
