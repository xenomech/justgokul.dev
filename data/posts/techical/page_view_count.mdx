...
<Grid>
  <Image
    alt={`create table`}
    tails={'p-2'}
    src={`https://static.justgokul.dev/media/blog/SupabasePageCount/CreateTable.png`}
    width={500}
    height={600}
    priority
  />
...
<Image
    ...
    tails={"p-2"}
    src={`https://static.justgokul.dev/media/blog/SupabasePageCount/DatabaseFunction.png`}
    width={500}
    height={700}
    priority
/>
