...
CloudFront is a CDN offered by Amazon Web Services, which securely transfers content to the clients, with speed.
...
With this we have a proper CDN delivering assets and a 'clean & light' codebase. And Thats it!! wasnt that simple!?
