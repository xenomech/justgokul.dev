...
function TwitterIcon({ className }: PropType) {
  return (
    <svg
      className={className}
      viewBox="0 0 16 16"
...
function GithubIcon({ className }: PropType) {
  return (
    <svg
      className={className}
      viewBox="0 0 16 16"
...
function CloseIcon({ className }: PropType) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function OpenExternal({ className }: PropType) {
  return (
    <svg
      className={className}
      viewBox="0 0 16 16"
